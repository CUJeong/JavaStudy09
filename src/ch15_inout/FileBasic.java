...
public class FileBasic {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(path);  // /home/ssam/IdeaProjects/JavaStudy

        // JavaStudy 내 src 폴더를 자바단의 File 객체로 불러오기
        // /home/ssam/IdeaProjects/JavaStudy/src = path + "/src"
        ...
        File comment = new File(fileArray[1] + "/Comments.java");
        ...
        // 존재하지 않는 파일 생성
        // temp 객체는 /home/ssam/IdeaProjects/JavaStudy/src/ch03_system/OperatorMain.java
        // 해당 경로에 대한 로컬파일이 생성됨
        try {
        ...
        for(int i = 0; i < stuList.size(); i++){
            File fold = new File("/home/ssam/stuList/" + stuList.get(i));
            fold.mkdir();
        }

        // 각 학생들 이름의 폴더 안에 id.txt 파일 한개씩 만들기
        for(int i = 0; i < stuList.size(); i++){
            File file = new File("/home/ssam/stuList/" + stuList.get(i) + "/id.txt");
            try {
                file.createNewFile();
            } catch (IOException e) {
                throw new RuntimeException(e);
